    ...
    public static Screen create(Screen parent) {
        return YetAnotherConfigLib.createBuilder()
                ...
                .category(ConfigCategory.createBuilder()
                        ...
                        .option(Option.<Boolean>createBuilder()
                                .name(Text.literal("Velocity vector"))
                                .description(OptionDescription.of(Text.literal("Show an arrow from the target's feet in the direction they're moving. Length scales with speed.")))
                                .binding(false, () -> ModConfig.velocityVector, v -> ModConfig.velocityVector = v)
                                .controller(TickBoxControllerBuilder::create)
                                .build())

                        .option(Option.<Float>createBuilder()
                                .name(Text.literal("Velocity vector scale"))
                                .description(OptionDescription.of(Text.literal("Multiplier for arrow length. Higher = longer arrow at same speed.")))
                                .binding(3.0f, () -> ModConfig.velocityVectorScale, v -> ModConfig.velocityVectorScale = v)
                                .controller(opt -> FloatSliderControllerBuilder.create(opt).range(0.5f, 10.0f).step(0.5f))
                                .build())

                        .option(Option.<Float>createBuilder()
                                .name(Text.literal("Velocity vector width"))
                                .description(OptionDescription.of(Text.literal("Thickness of the velocity arrow line.")))
                                .binding(2.0f, () -> ModConfig.velocityVectorWidth, v -> ModConfig.velocityVectorWidth = v)
                                .controller(opt -> FloatSliderControllerBuilder.create(opt).range(2.0f, 8.0f).step(0.5f))
                                .build())

                        .option(Option.<Color>createBuilder()
                                .name(Text.literal("Velocity vector color"))
                                .description(OptionDescription.of(Text.literal("Color of the velocity arrow.")))
                                .binding(new Color(ModConfig.colorVelocityVector, true), () -> new Color(ModConfig.colorVelocityVector, true), v -> ModConfig.colorVelocityVector = v.getRGB())
