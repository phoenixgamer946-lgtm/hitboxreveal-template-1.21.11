        ...
        return YetAnotherConfigLib.createBuilder()
                ...
                .category(ConfigCategory.createBuilder()
                        ...
                        .group(OptionGroup.createBuilder()
                                ...
                                .option(Option.<Boolean>createBuilder()
                                        .name(Text.literal("Enabled"))
                                        .binding(false, () -> ModConfig.spectralArrowEnabled, v -> ModConfig.spectralArrowEnabled = v)
                                        .controller(TickBoxControllerBuilder::create)
                                        .build())
                                .option(Option.<Color>createBuilder()
                                        .name(Text.literal("Color"))
                                        .binding(new Color(ModConfig.colorSpectralArrow, true), () -> new Color(ModConfig.colorSpectralArrow, true), v -> ModConfig.colorSpectralArrow = v.getRGB())
                                        .controller(opt -> ColorControllerBuilder.create(opt).allowAlpha(false))
                                        .build())
                                .option(Option.<Float>createBuilder()
                                        .name(Text.literal("Size multiplier"))
                                        .binding(1.0f, () -> ModConfig.spectralArrowSizeMulti, v -> ModConfig.spectralArrowSizeMulti = v)
                                        .controller(opt -> FloatSliderControllerBuilder.create(opt).range(0.5f, 5.0f).step(0.25f).valueFormatter(f -> Text.literal(String.format("%.2fx", f))))
                                        .build())
                                .option(Option.<Boolean>createBuilder()
                                        .name(Text.literal("Outline only"))
                                        .binding(false, () -> ModConfig.spectralArrowOutlineOnly, v -> ModConfig.spectralArrowOutlineOnly = v)
                                        .controller(TickBoxControllerBuilder::create)
                                        .build())
                                .build())
                        ...
                        .group(OptionGroup.createBuilder()
                                ...
                                .option(Option.<Boolean>createBuilder()
                                        .name(Text.literal("Enabled"))
                                        .binding(true, () -> ModConfig.tridentEnabled, v -> ModConfig.tridentEnabled = v)
                                        .controller(TickBoxControllerBuilder::create)
                                        .build())
                                .option(Option.<Color>createBuilder()
                                        .name(Text.literal("Color"))
                                        .binding(new Color(ModConfig.colorTrident, true), () -> new Color(ModConfig.colorTrident, true), v -> ModConfig.colorTrident = v.getRGB())
                                        .controller(opt -> ColorControllerBuilder.create(opt).allowAlpha(false))
                                        .build())
                                .option(Option.<Float>createBuilder()
                                        .name(Text.literal("Size multiplier"))
                                        .binding(1.0f, () -> ModConfig.tridentSizeMulti, v -> ModConfig.tridentSizeMulti = v)
                                        .controller(opt -> FloatSliderControllerBuilder.create(opt).range(0.5f, 5.0f).step(0.25f).valueFormatter(f -> Text.literal(String.format("%.2fx", f))))
                                        .build())
                                .option(Option.<Boolean>createBuilder()
                                        .name(Text.literal("Outline only"))
                                        .binding(false, () -> ModConfig.tridentOutlineOnly, v -> ModConfig.tridentOutlineOnly = v)
                                        .controller(TickBoxControllerBuilder::create)
                                        .build())
                                .build())
                        ...
                        .group(OptionGroup.createBuilder()
                                ...
                                .option(Option.<Boolean>createBuilder()
                                        .name(Text.literal("Enabled"))
                                        .binding(false, () -> ModConfig.snowballEnabled, v -> ModConfig.snowballEnabled = v)
                                        .controller(TickBoxControllerBuilder::create)
                                        .build())
                                .option(Option.<Color>createBuilder()
                                        .name(Text.literal("Color"))
                                        .binding(new Color(ModConfig.colorSnowball, true), () -> new Color(ModConfig.colorSnowball, true), v -> ModConfig.colorSnowball = v.getRGB())
                                        .controller(opt -> ColorControllerBuilder.create(opt).allowAlpha(false))
                                        .build())
                                .option(Option.<Float>createBuilder()
                                        .name(Text.literal("Size multiplier"))
                                        .binding(1.0f, () -> ModConfig.snowballSizeMulti, v -> ModConfig.snowballSizeMulti = v)
                                        .controller(opt -> FloatSliderControllerBuilder.create(opt).range(0.5f, 5.0f).step(0.25f).valueFormatter(f -> Text.literal(String.format("%.2fx", f))))
                                        .build())
                                .option(Option.<Boolean>createBuilder()
                                        .name(Text.literal("Outline only"))
                                        .binding(false, () -> ModConfig.snowballOutlineOnly, v -> ModConfig.snowballOutlineOnly = v)
                                        .controller(TickBoxControllerBuilder::create)
                                        .build())
                                .build())
                        ...
                        .group(OptionGroup.createBuilder()
                                ...
                                .option(Option.<Boolean>createBuilder()
                                        .name(Text.literal("Enabled"))
                                        .binding(false, () -> ModConfig.eggEnabled, v -> ModConfig.eggEnabled = v)
                                        .controller(TickBoxControllerBuilder::create)
                                        .build())
                                .option(Option.<Color>createBuilder()
                                        .name(Text.literal("Color"))
                                        .binding(new Color(ModConfig.colorEgg, true), () -> new Color(ModConfig.colorEgg, true), v -> ModConfig.colorEgg = v.getRGB())
                                        .controller(opt -> ColorControllerBuilder.create(opt).allowAlpha(false))
                                        .build())
                                .option(Option.<Float>createBuilder()
                                        .name(Text.literal("Size multiplier"))
                                        .binding(1.0f, () -> ModConfig.eggSizeMulti, v -> ModConfig.eggSizeMulti = v)
                                        .controller(opt -> FloatSliderControllerBuilder.create(opt).range(0.5f, 5.0f).step(0.25f).valueFormatter(f -> Text.literal(String.format("%.2fx", f))))
                                        .build())
                                .option(Option.<Boolean>createBuilder()
                                        .name(Text.literal("Outline only"))
                                        .binding(false, () -> ModConfig.eggOutlineOnly, v -> ModConfig.eggOutlineOnly = v)
                                        .controller(TickBoxControllerBuilder::create)
                                        .build())
                                .build())
                        ...
                        .group(OptionGroup.createBuilder()
                                ...
                                .option(Option.<Boolean>createBuilder()
                                        .name(Text.literal("Enabled"))
                                        .description(OptionDescription.of(Text.literal("Show hitbox for thrown splash and lingering potions.")))
                                        .binding(true, () -> ModConfig.potionEnabled, v -> ModConfig.potionEnabled = v)
                                        .controller(TickBoxControllerBuilder::create)
                                        .build())
                                .option(Option.<Color>createBuilder()
                                        .name(Text.literal("Color"))
                                        .binding(new Color(ModConfig.colorPotion, true), () -> new Color(ModConfig.colorPotion, true), v -> ModConfig.colorPotion = v.getRGB())
                                        .controller(opt -> ColorControllerBuilder.create(opt).allowAlpha(false))
                                        .build())
                                .option(Option.<Float>createBuilder()
                                        .name(Text.literal("Size multiplier"))
                                        .binding(1.0f, () -> ModConfig.potionSizeMulti, v -> ModConfig.potionSizeMulti = v)
                                        .controller(opt -> FloatSliderControllerBuilder.create(opt).range(0.5f, 5.0f).step(0.25f).valueFormatter(f -> Text.literal(String.format("%.2fx", f))))
                                        .build())
                                .option(Option.<Boolean>createBuilder()
                                        .name(Text.literal("Outline only"))
                                        .binding(false, () -> ModConfig.potionOutlineOnly, v -> ModConfig.potionOutlineOnly = v)
                                        .controller(TickBoxControllerBuilder::create)
                                        .build())
                                .build())
                        ...
                        .group(OptionGroup.createBuilder()
                                ...
                                .option(Option.<Boolean>createBuilder()
                                        .name(Text.literal("Enabled"))
                                        .binding(true, () -> ModConfig.witherSkullEnabled, v -> ModConfig.witherSkullEnabled = v)
                                        .controller(TickBoxControllerBuilder::create)
                                        .build())
                                .option(Option.<Color>createBuilder()
                                        .name(Text.literal("Color"))
                                        .binding(new Color(ModConfig.colorWitherSkull, true), () -> new Color(ModConfig.colorWitherSkull, true), v -> ModConfig.colorWitherSkull = v.getRGB())
                                        .controller(opt -> ColorControllerBuilder.create(opt).allowAlpha(false))
                                        .build())
                                .option(Option.<Float>createBuilder()
                                        .name(Text.literal("Size multiplier"))
                                        .binding(1.0f, () -> ModConfig.witherSkullSizeMulti, v -> ModConfig.witherSkullSizeMulti = v)
                                        .controller(opt -> FloatSliderControllerBuilder.create(opt).range(0.5f, 5.0f).step(0.25f).valueFormatter(f -> Text.literal(String.format("%.2fx", f))))
                                        .build())
                                .option(Option.<Boolean>createBuilder()
                                        .name(Text.literal("Outline only"))
                                        .binding(false, () -> ModConfig.witherSkullOutlineOnly, v -> ModConfig.witherSkullOutlineOnly = v)
                                        .controller(TickBoxControllerBuilder::create)
                                        .build())
                                .build())
                        ...
                        .group(OptionGroup.createBuilder()
                                ...
                                .option(Option.<Boolean>createBuilder()
                                        .name(Text.literal("Enabled"))
                                        .binding(true, () -> ModConfig.shulkerBulletEnabled, v -> ModConfig.shulkerBulletEnabled = v)
                                        .controller(TickBoxControllerBuilder::create)
                                        .build())
                                .option(Option.<Color>createBuilder()
                                        .name(Text.literal("Color"))
                                        .binding(new Color(ModConfig.colorShulkerBullet, true), () -> new Color(ModConfig.colorShulkerBullet, true), v -> ModConfig.colorShulkerBullet = v.getRGB())
                                        .controller(opt -> ColorControllerBuilder.create(opt).allowAlpha(false))
                                        .build())
                                .option(Option.<Float>createBuilder()
                                        .name(Text.literal("Size multiplier"))
                                        .binding(1.0f, () -> ModConfig.shulkerBulletSizeMulti, v -> ModConfig.shulkerBulletSizeMulti = v)
                                        .controller(opt -> FloatSliderControllerBuilder.create(opt).range(0.5f, 5.0f).step(0.25f).valueFormatter(f -> Text.literal(String.format("%.2fx", f))))
                                        .build())
                                .option(Option.<Boolean>createBuilder()
                                        .name(Text.literal("Outline only"))
                                        .binding(false, () -> ModConfig.shulkerBulletOutlineOnly, v -> ModConfig.shulkerBulletOutlineOnly = v)
                                        .controller(TickBoxControllerBuilder::create)
                                        .build())
                                .build())
                        ...
                        .group(OptionGroup.createBuilder()
                                ...
                                .option(Option.<Boolean>createBuilder()
                                        .name(Text.literal("Enabled"))
                                        .binding(true, () -> ModConfig.endCrystalEnabled, v -> ModConfig.endCrystalEnabled = v)
                                        .controller(TickBoxControllerBuilder::create)
                                        .build())
                                .option(Option.<Color>createBuilder()
                                        .name(Text.literal("Color"))
                                        .binding(new Color(ModConfig.colorEndCrystal, true), () -> new Color(ModConfig.colorEndCrystal, true), v -> ModConfig.colorEndCrystal = v.getRGB())
                                        .controller(opt -> ColorControllerBuilder.create(opt).allowAlpha(false))
                                        .build())
                                .option(Option.<Float>createBuilder()
                                        .name(Text.literal("Size multiplier"))
                                        .binding(1.0f, () -> ModConfig.endCrystalSizeMulti, v -> ModConfig.endCrystalSizeMulti = v)
                                        .controller(opt -> FloatSliderControllerBuilder.create(opt).range(0.5f, 5.0f).step(0.25f).valueFormatter(f -> Text.literal(String.format("%.2fx", f))))
                                        .build())
                                .option(Option.<Boolean>createBuilder()
                                        .name(Text.literal("Outline only"))
                                        .binding(false, () -> ModConfig.endCrystalOutlineOnly, v -> ModConfig.endCrystalOutlineOnly = v)
                                        .controller(TickBoxControllerBuilder::create)
                                        .build())
                                .build())
                        ...
                        .group(OptionGroup.createBuilder()
                                ...
                                .option(Option.<Boolean>createBuilder()
                                        .name(Text.literal("Enabled"))
                                        .description(OptionDescription.of(Text.literal("Show hitbox for lit TNT blocks.")))
                                        .binding(true, () -> ModConfig.tntEnabled, v -> ModConfig.tntEnabled = v)
                                        .controller(TickBoxControllerBuilder::create)
                                        .build())
                                .option(Option.<Color>createBuilder()
                                        .name(Text.literal("Color"))
                                        .binding(new Color(ModConfig.colorTnt, true), () -> new Color(ModConfig.colorTnt, true), v -> ModConfig.colorTnt = v.getRGB())
                                        .controller(opt -> ColorControllerBuilder.create(opt).allowAlpha(false))
                                        .build())
                                .option(Option.<Float>createBuilder()
                                        .name(Text.literal("Size multiplier"))
                                        .binding(1.0f, () -> ModConfig.tntSizeMulti, v -> ModConfig.tntSizeMulti = v)
                                        .controller(opt -> FloatSliderControllerBuilder.create(opt).range(0.5f, 3.0f).step(0.1f))
                                        .build())
                                .option(Option.<Boolean>createBuilder()
                                        .name(Text.literal("Outline only"))
                                        .binding(false, () -> ModConfig.tntOutlineOnly, v -> ModConfig.tntOutlineOnly = v)
                                        .controller(TickBoxControllerBuilder::create)
                                        .build())
                                .build())

                        .group(OptionGroup.createBuilder()
                                .name(Text.literal("Firework"))
                                .option(Option.<Boolean>createBuilder()
                                        .name(Text.literal("Enabled"))
                                        .binding(false, () -> ModConfig.fireworkEnabled, v -> ModConfig.fireworkEnabled = v)
                                        .controller(TickBoxControllerBuilder::create)
                                        .build())
                                .option(Option.<Color>createBuilder()
                                        .name(Text.literal("Color"))
                                        .binding(new Color(ModConfig.colorFirework, true), () -> new Color(ModConfig.colorFirework, true), v -> ModConfig.colorFirework = v.getRGB())
                                        .controller(opt -> ColorControllerBuilder.create(opt).allowAlpha(false))
                                        .build())
                                .option(Option.<Float>createBuilder()
                                        .name(Text.literal("Size multiplier"))
                                        .binding(1.0f, () -> ModConfig.fireworkSizeMulti, v -> ModConfig.fireworkSizeMulti = v)
                                        .controller(opt -> FloatSliderControllerBuilder.create(opt).range(0.5f, 3.0f).step(0.1f))
                                        .build())
                                .option(Option.<Boolean>createBuilder()
                                        .name(Text.literal("Outline only"))
                                        .binding(false, () -> ModConfig.fireworkOutlineOnly, v -> ModConfig.fireworkOutlineOnly = v)
                                        .controller(TickBoxControllerBuilder::create)
                                        .build())
                                .build())
                        ...
                        .group(OptionGroup.createBuilder()
                                ...
                                .option(Option.<Boolean>createBuilder()
                                        .name(Text.literal("Enabled"))
                                        .description(OptionDescription.of(Text.literal("Show hitbox for lingering potion clouds.")))
                                        .binding(false, () -> ModConfig.areaEffectCloudEnabled, v -> ModConfig.areaEffectCloudEnabled = v)
                                        .controller(TickBoxControllerBuilder::create)
                                        .build())
                                .option(Option.<Color>createBuilder()
                                        .name(Text.literal("Color"))
                                        .binding(new Color(ModConfig.colorAreaEffectCloud, true), () -> new Color(ModConfig.colorAreaEffectCloud, true), v -> ModConfig.colorAreaEffectCloud = v.getRGB())
                                        .controller(opt -> ColorControllerBuilder.create(opt).allowAlpha(false))
                                        .build())
                                .option(Option.<Float>createBuilder()
                                        .name(Text.literal("Size multiplier"))
                                        .binding(1.0f, () -> ModConfig.areaEffectCloudSizeMulti, v -> ModConfig.areaEffectCloudSizeMulti = v)
                                        .controller(opt -> FloatSliderControllerBuilder.create(opt).range(0.5f, 3.0f).step(0.1f))
                                        .build())
                                .option(Option.<Boolean>createBuilder()
                                        .name(Text.literal("Outline only"))
                                        .binding(false, () -> ModConfig.areaEffectCloudOutlineOnly, v -> ModConfig.areaEffectCloudOutlineOnly = v)
                                        .controller(TickBoxControllerBuilder::create)
                                        .build())
                                .build())
                        ...
                        .group(OptionGroup.createBuilder()
                                ...
                                .option(Option.<Boolean>createBuilder()
                                        .name(Text.literal("Enabled"))
                                        .binding(false, () -> ModConfig.evokerFangsEnabled, v -> ModConfig.evokerFangsEnabled = v)
                                        .controller(TickBoxControllerBuilder::create)
                                        .build())
                                .option(Option.<Color>createBuilder()
                                        .name(Text.literal("Color"))
                                        .binding(new Color(ModConfig.colorEvokerFangs, true), () -> new Color(ModConfig.colorEvokerFangs, true), v -> ModConfig.colorEvokerFangs = v.getRGB())
                                        .controller(opt -> ColorControllerBuilder.create(opt).allowAlpha(false))
                                        .build())
                                .option(Option.<Float>createBuilder()
                                        .name(Text.literal("Size multiplier"))
                                        .binding(1.0f, () -> ModConfig.evokerFangsSizeMulti, v -> ModConfig.evokerFangsSizeMulti = v)
                                        .controller(opt -> FloatSliderControllerBuilder.create(opt).range(0.5f, 3.0f).step(0.1f))
                                        .build())
                                .option(Option.<Boolean>createBuilder()
                                        .name(Text.literal("Outline only"))
                                        .binding(false, () -> ModConfig.evokerFangsOutlineOnly, v -> ModConfig.evokerFangsOutlineOnly = v)
                                        .controller(TickBoxControllerBuilder::create)
                                        .build())
                                .build())
                        ...
                        .group(OptionGroup.createBuilder()
                                ...
                                .option(Option.<Boolean>createBuilder()
                                        .name(Text.literal("Enabled"))
                                        .binding(false, () -> ModConfig.eyeOfEnderEnabled, v -> ModConfig.eyeOfEnderEnabled = v)
                                        .controller(TickBoxControllerBuilder::create)
                                        .build())
                                .option(Option.<Color>createBuilder()
                                        .name(Text.literal("Color"))
                                        .binding(new Color(ModConfig.colorEyeOfEnder, true), () -> new Color(ModConfig.colorEyeOfEnder, true), v -> ModConfig.colorEyeOfEnder = v.getRGB())
                                        .controller(opt -> ColorControllerBuilder.create(opt).allowAlpha(false))
                                        .build())
                                .option(Option.<Float>createBuilder()
                                        .name(Text.literal("Size multiplier"))
                                        .binding(1.0f, () -> ModConfig.eyeOfEnderSizeMulti, v -> ModConfig.eyeOfEnderSizeMulti = v)
                                        .controller(opt -> FloatSliderControllerBuilder.create(opt).range(0.5f, 3.0f).step(0.1f))
                                        .build())
                                .option(Option.<Boolean>createBuilder()
                                        .name(Text.literal("Outline only"))
                                        .binding(false, () -> ModConfig.eyeOfEnderOutlineOnly, v -> ModConfig.eyeOfEnderOutlineOnly = v)
                                        .controller(TickBoxControllerBuilder::create)
                                        .build())
                                .build())
                        ...
                        .group(OptionGroup.createBuilder()
                                ...
                                .option(Option.<Boolean>createBuilder()
                                        .name(Text.literal("Enabled"))
                                        .binding(false, () -> ModConfig.fishingBobberEnabled, v -> ModConfig.fishingBobberEnabled = v)
                                        .controller(TickBoxControllerBuilder::create)
                                        .build())
                                .option(Option.<Color>createBuilder()
                                        .name(Text.literal("Color"))
                                        .binding(new Color(ModConfig.colorFishingBobber, true), () -> new Color(ModConfig.colorFishingBobber, true), v -> ModConfig.colorFishingBobber = v.getRGB())
                                        .controller(opt -> ColorControllerBuilder.create(opt).allowAlpha(false))
                                        .build())
                                .option(Option.<Float>createBuilder()
                                        .name(Text.literal("Size multiplier"))
                                        .binding(1.0f, () -> ModConfig.fishingBobberSizeMulti, v -> ModConfig.fishingBobberSizeMulti = v)
                                        .controller(opt -> FloatSliderControllerBuilder.create(opt).range(0.5f, 3.0f).step(0.1f))
                                        .build())
                                .option(Option.<Boolean>createBuilder()
                                        .name(Text.literal("Outline only"))
                                        .binding(false, () -> ModConfig.fishingBobberOutlineOnly, v -> ModConfig.fishingBobberOutlineOnly = v)
                                        .controller(TickBoxControllerBuilder::create)
                                        .build())
                                .build())
