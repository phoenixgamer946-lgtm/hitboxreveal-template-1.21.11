...
public class HitboxRenderer {
    ...
    public static void renderBox(WorldRenderContext context, PlayerEntity target, int argbColor) {
        ...
        // SMOOTHNESS FIX: interpolate entity position at sub-tick precision
        ...
        if (fa > 0.01f) {
            ...
            for (Direction dir : Direction.values()) {
                ...
                drawSide(mat, fill, dir,
                        ...
                        r, g, b, fa,   // bottom color
                        cr, cg, cb, fa // top color
                );
            }
        }
        ...
        if (ModConfig.lookVector) {
            ...
            Quaternionf rot = new Quaternionf().rotationTo(
                    new Vector3f(1, 0, 0), dir.toVector3f());
            float size = 0.2f;
            Vector3f[] fins = {
    ...
    // Draws one face — bottom verts use r/g/b/a, top verts use r2/g2/b2/a2
    ...
    // Convenience overload for single-color lines (eye box, look vector)
